...
public class SpecificationController {
     ...
     */
    @GetMapping("/group")
    public ResponseEntity<List<SpecGroup>> querySpecGroupAllByCid(@RequestParam("cid") Long cid){
        return ResponseEntity.ok(specificationService.querySpecGroupAllByCid(cid));
    }
}
